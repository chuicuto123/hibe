...
-- (DA GO theo yeu cau chong: BlockWorldTravel / AntiTeleport / AutoWorldTravel.
--  Script KHONG con can thiep chuyen doi map nua - chay o map nao thi dung script cua map do.
...
-- (DA GO: WorldTravelGuard / AntiTeleport / AutoWorldTravel - theo yeu cau chong.
--  Script khong chan teleport va khong tu di map nua.)
